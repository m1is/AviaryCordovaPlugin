...
public class GlowDrawable extends Drawable {
	...
	public GlowDrawable ( Resources res, Drawable drawable, int color_pressed, int color_checked, int color_selected,
	...
	private void initialize( int color_pressed, int color_checked, int color_selected, int blur_size, int highlightMode,
			int glowMode ) {
