...
public class GlowBitmapDrawable extends FastBitmapDrawable {
	...
	public GlowBitmapDrawable( Resources res, Bitmap bitmap, int color_pressed, int color_checked, int color_selected,
			int blur_size, int highlightMode, int glowMode ) {
		super( bitmap );
	...
	public void updateConfig( int color_pressed, int color_checked, int color_selected, int blur_size, int highlightMode,
			int glowMode ) {
		init( color_pressed, color_checked, color_selected, blur_size, highlightMode, glowMode );
		setState( getState() );
	}
