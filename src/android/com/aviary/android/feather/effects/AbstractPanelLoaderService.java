...
public class AbstractPanelLoaderService extends BaseContextService {
	...
	/**
	 * Passing a {@link ToolEntry} return an instance of {@link AbstractPanel}
	...
	static {
		mAllEntries = new ToolEntry[] {
				new ToolEntry( FilterLoaderFactory.Filters.ENHANCE, R.drawable.aviary_tool_ic_enhance, R.string.feather_enhance ),
