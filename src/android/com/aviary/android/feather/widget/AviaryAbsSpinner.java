/*
 * Copyright (C) 2006 The Android Open Source Project Licensed under the Apache License, Version 2.0 (the "License"); you may not
...
public abstract class AviaryAbsSpinner extends AviaryAdapterView<Adapter> {
	...
	static class SavedState extends BaseSavedState {
		...
		public String toString() {
			return "AviaryAbsSpinner.SavedState{" + Integer.toHexString( System.identityHashCode( this ) ) + " selectedId="
